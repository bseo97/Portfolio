    ...
    <div className="chatbot-container">
      <style jsx>{`
        ...
        .chatbot-form {
          ...
          align-items: center;
          padding: 1rem 1.5rem;
          border-top: ${isExpanded ? '1px solid rgba(255, 255, 255, 0.1)' : 'none'};
          background: rgba(255, 255, 255, 0.05);
          position: relative;
          flex-shrink: 0;
        }
      ...
      <div className={`chatbot-wrapper ${isExpanded ? 'expanded' : ''}`}>
        {isExpanded && (
          <>
